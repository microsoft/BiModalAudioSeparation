...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_audio', default='data/music/audio',
                        help="root for extracted audio files")
    parser.add_argument('--root_frame', default='data/music/frames',
                        help="root for extracted video frames")
    parser.add_argument('--fps', default=1, type=int,
                        help="fps of video frames")
    parser.add_argument('--path_output', default='data/music/annotaitons',
    ...
    testset = infos[n_train:]
    for name, subset in zip(['train', 'test'], [trainset, testset]):
