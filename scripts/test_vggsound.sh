...
python main.py --id Proposed_VGGSound --mode test --dataset vggsound --list_train data/vggsound/annotations/train.csv \
                --list_test data/vggsound/annotations/test_sep_2.csv --audio_dir data/vggsound/audio \
                ...
                --warmup_epochs 1 --eval_epoch 2 --n_sources 2 \
                --test_num_mix 2 --load /path/to/checkpoint